  ...
  return (
    <div className={styles.item}>
      <div className={styles.item_main}>
        ...
        <p className={completed? styles.item_time_completed : styles.item_time}>{timeConverter.dateToLocalDateTime(deadline)}</p>
        <p className={completed? styles.item_time_completed : styles.item_time}>{created}</p>
      ...
      <div>
        {body && <p className={completed? styles.item_body_completed : styles.item_body}>{body}</p>}
      </div>
    </div>
  )
}
